...
/** ReputationRegistry 768572969, box sc_ + uint64(1): the live agent's score.
...
/** ValidationRegistry 768572979, box jb_ + uint64(1). A VALIDATED job: the two
...
describe("pickAgent", () => {
  ...
  it("reads the box the contract actually writes", async () => {
    ...
    expect(algod.seen[0]).toContain("/v2/applications/768572969/box?name=");
  });
              ...
              : [
                  {
                    ...
                    params: { agentId: opts.agentId ?? 1, identityApp: 768_572_968 },
                  },
                ],
        },
      });
...
const IDENTITY = 768_572_968;
const VALIDATION = 768_572_979;
