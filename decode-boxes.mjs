/**
 * Dump the registry boxes as the decoders see them. A debugging aid, not a
 * proof — deploy-v2.mjs is what actually attacks the contracts.
 */
...
const raw = await box(768570170, agName);
...
const s = scoreT.decode(await box(768570171, scName));
...
const j = jobT.decode(await box(768570174, jbName));
